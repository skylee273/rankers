...
class LeagueResultAdapter(val mGroupResponseList: MutableList<GroupResponse.Group>?) : RecyclerView.Adapter<BaseViewHolder>() {
    ...
    fun modifyPlayer(position: Int, type: Int, winScore: String, loseScore: String) {
        ...
        setRank(this.mGroupResponseList!![position].groupTotal1!!.toInt(), this.mGroupResponseList[position].groupTotal2!!.toInt(), this.mGroupResponseList[position].groupTotal3!!.toInt(),
                this.mGroupResponseList[position].groupTotal4!!.toInt(), this.mGroupResponseList[position].groupGain1!!.toInt(), this.mGroupResponseList[position].groupGain2!!.toInt(),
                this.mGroupResponseList[position].groupGain3!!.toInt(), this.mGroupResponseList[position].groupGain4!!.toInt(), position)
